...
const Register = () => {
  ...
  return (
    <div className="bg-[url('/Images/Home/image_1.jpg')] bg-cover bg-center flex text-start items-center justify-center flex-col min-h-screen box-border">
      <div className="flex text-start items-center justify-center flex-col min-h-screen h-full w-full bg-black/60 bg-cover bg-center">
        <div
          id="main"
